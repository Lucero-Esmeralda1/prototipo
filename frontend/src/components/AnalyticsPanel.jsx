...
// export default function AnalyticsPanel({ papers, graphData }) {
//   const sourcePapers = graphData?.nodes?.length ? graphData.nodes : papers;

//   const totalPapers = sourcePapers.length || 0;

//   const totalCitations = sourcePapers.reduce(
//     (sum, paper) => sum + Number(paper.citation_count || 0),
//     0
//   );
...
//       acc[year].papers += 1;
//       acc[year].citations += Number(paper.citation_count || 0);
...
//       <div className="analytics-header">
//         <h2>Timeline & Analytics</h2>
//         <p>Explore citation trends and influential papers over time</p>
//       </div>
...
//       <div className="chart-card">
//         <h3>Citation Growth Over Time</h3>
